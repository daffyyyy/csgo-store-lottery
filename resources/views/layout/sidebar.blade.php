...
<div class="col-span-12 p-4 md:pt-0 shadow-xl rounded-md dark:bg-gray-800 border border-gray-700">
    <div class="flex items-center justify-between p-4 align-middle">
        <h4 class="text-lg font-semibold text-gray-500 dark:text-light">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                class="h-10 w-10 inline-block mr-2" viewBox="0 0 53.626 53.626" fill="currentColor"
                xml:space="preserve">
    ...
    <div class="relative p-4">
        <p class="whitespace-pre-line">Hej, jeżeli trafiłeś tutaj przypadkiem to może masz chęc postrzelać razem z nami?
            ...
            Miło będzie Cię poznać i razem budować społeczność wartościowych graczy <i
                class="far fa-smile-wink text-indigo-500" aria-hidden="true"></i>
