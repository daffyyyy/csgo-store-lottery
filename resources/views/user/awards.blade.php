...
@section('title_body')
    ...
    <span class="text-gray-200 text-lg">Twoje nagrody</span>
@endsection
            ...
            <table class="border-collapse w-full">
                <thead>
                    <tr>
                        ...
                        <th class="p-3 font-bold uppercase text-indigo-600 hidden lg:table-cell">Status</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($awards as $award)
                        <tr class="flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            <td class="w-full lg:w-auto p-3 text-white text-center block lg:table-cell relative lg:static">
                                ...
                                <img class="w-48 h-34 inline-block" src="{{ $award->image }}" />
                            </td>
                            <td class="w-full lg:w-auto p-3 text-white text-center block lg:table-cell relative lg:static">
                                <span
                            ...
                            <td class="w-full lg:w-auto p-3 text-white text-center block lg:table-cell relative lg:static">
                                <span
                                    class="lg:hidden absolute top-0 left-0 bg-green-600 px-2 py-1 text-xs font-bold uppercase">Status</span>
                                @if ($award->status === 1)
                                    <button
                                        class="whitespace-nowrap p-2 lg:px-4 md:mx-2 text-green-600 text-center border border-solid border-green-600 rounded hover:bg-green-600 hover:text-gray-200 transition-colors duration-300 mt-1 md:mt-0 md:ml-1"><i class="fas fa-check"></i>&nbsp;&nbsp;<strong
                                            class="text-white">Odebrane</strong></button>
                                @else
                                    <button
                                        class="whitespace-nowrap p-2 lg:px-4 md:mx-2 text-gray-600 text-center border border-solid border-gray-600 rounded hover:bg-gray-600 hover:text-gray-200 transition-colors duration-300 mt-1 md:mt-0 md:ml-1"><i class="far fa-clock"></i>&nbsp;&nbsp;<strong
                                            class="text-white">Oczekuje</strong></button>
                                @endif
                            </td>
