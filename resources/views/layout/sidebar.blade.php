...
<div class="col-span-12 p-4 md:pt-0 shadow-xl rounded-md dark:bg-gray-800 border border-gray-700">
    ...
    <div class="relative p-4">
        <p class="whitespace-pre-line">Hej, jeżeli trafiłeś tutaj przypadkiem to może masz chęc postrzelać razem z nami?

        Miło będzie Cię poznać i razem budować społeczność wartościowych graczy <i class="far fa-smile-wink text-indigo-500" aria-hidden="true"></i>
        Wpadnij do nas na <a href="https://utopiafps.pl">UtopiaFPS.pl</a>
        </p>
    </div>
</div>
{{-- <!-- Start new sidebar --> --}}
